...
public class CustTest {
	...
	private final static Collection<Case> testData = Arrays.asList(
			new Case("Windows NT",          "10.0",     "Chrome",        "61.0.3163.100", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Firefox",       "56.0",          "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:56.0) Gecko/20100101 Firefox/56.0"),
			new Case("Windows NT",          "10.0",     "Chrome",        "62.0.3202.94",  "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "62.0.3202.89",  "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.89 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "62.0.3202.75",  "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.75 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Firefox",       "57.0",          "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:57.0) Gecko/20100101 Firefox/57.0"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "52.0.2743.116", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Safari/537.36 Edge/15.15063"),
			new Case("Windows NT",          "10.0",     "Chrome",        "62.0.3202.62",  "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.62 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Mozilla",       "rv:11.0",       "Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko"),
			...
			new Case("Windows NT",          "10.0",     "Opera",         "48.0.2685.52",  "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36 OPR/48.0.2685.52"),
			new Case("Windows NT",          "10.0",     "Chrome",        "58.0.3029.110", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36 Edge/16.16299"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "60.0.3112.113", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/60.0.3112.113 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Firefox",       "56.0",          "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:56.0) Gecko/20100101 Firefox/56.0"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "51.0.2704.79",  "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.79 Safari/537.36 Edge/14.14393"),
			...
			new Case("Windows NT",          "10.0",     "Mozilla",       "rv:11.0",       "Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; Touch; rv:11.0) like Gecko"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "61.0.3163.100", "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Chrome",        "61.0.3163.100", "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36"),
			...
			new Case("Windows NT",          "10.0",     "Firefox",       "52.0",          "Mozilla/5.0 (Windows NT 10.0; WOW64; rv:52.0) Gecko/20100101 Firefox/52.0"),
	...
	public void testParse() {
		for(final Case expected: testData) {
			...
			UserAgentDetectionResult res = new UserAgentDetector().parseUserAgent(expected.getUserAgent());

			assertEquals("os name",         expected.getOsName(),         res.getOperatingSystem().getDescription());
			assertEquals("os version",      expected.getOsVersion(),      res.getOperatingSystem().getVersion());
			assertEquals("browser name",    expected.getBrowserName(),    res.getBrowser().getDescription());
			assertEquals("browser version", expected.getBrowserVersion(), res.getBrowser().getFullVersion());
		}
	}
